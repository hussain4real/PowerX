...
class EditCoursePackage extends EditRecord
{
    ...
    {
        if (! $this->record instanceof CoursePackage) {
            return;
        }
        ...
        app(RecordAssessmentConfigurationChange::class)->handle(
            ...
            metadata: ['configuration_scope' => 'package_certificate_requirements'],
        );
    }
    ...
    private function assessmentConfigurationSnapshot(): array
    {
        ...
        return [
            'max_exam_attempts' => $this->record->max_exam_attempts,
            'includes_certificate' => $this->record->includes_certificate,
            ...
            'allows_free_preview' => $this->record->allows_free_preview,
        ];
    }
}
