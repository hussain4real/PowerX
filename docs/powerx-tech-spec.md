...
| Audit               | spatie/laravel-activitylog:^4.0                                                                            | Log sensitive model events and user actions. Confirm Laravel 13 composer compatibility at project bootstrap and raise a change request if v5 is required. |
| Data objects        | spatie/laravel-data:^4.0                                                                                   | Use DTOs for complex forms, service boundaries, reports, and predictable TypeScript-facing data structures.                                               |
